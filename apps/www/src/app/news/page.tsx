      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-2xl font-bold mb-8 text-[#094a94]">
              Latest Articles
            </h2>
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <Link href={`/news/${post.slug}`}>
                      <h3 className="text-xl font-bold text-gray-800 hover:text-[#094a94] transition mb-2">
                        {post.title}
                      </h3>
                    </Link>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link
                        href={`/news/${post.slug}`}
                        className="text-sm text-[#094a94] font-medium hover:underline"
                      >
                        Read more
                      </Link>
                    </div>
          ...
          >
            <nav className="flex items-center space-x-2">
              ...
              <button className="px-4 py-2 bg-[#094a94] text-white rounded-md">
                1
              </button>
